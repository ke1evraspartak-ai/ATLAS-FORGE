...
export default function ManagerLeadsPage() {
  ...
  const visibleOffersForCounter = offers.filter((offer) => {
  ...
  return offer.manager_id === managerFilter;
});

const newCartLeadsCount = visibleOffersForCounter.filter(
  (offer) =>
