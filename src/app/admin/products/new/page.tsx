  ...
  return (
    <main className="bg-[#111111] text-white min-h-screen">
      <div className="max-w-5xl mx-auto px-6 py-32">
        ...
        <h1 className="text-5xl font-black">Добавление товара</h1>
        ...
        <div className="space-y-10 mt-12">
          <div className="bg-zinc-900 rounded-3xl p-8 border border-zinc-800">
            ...
            <div className="space-y-5">
              ...
              <select
                className="w-full bg-black border border-zinc-700 rounded-xl p-4"
                value={form.category}
                disabled={!form.section || availableSubcategories.length === 0}
          ...
          <div className="bg-zinc-900 rounded-3xl p-8 border border-zinc-800">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <input
                className="md:col-span-2 w-full bg-black border border-zinc-700 rounded-xl p-4"
                placeholder="Цена в рублях"
                value={form.price}
                onChange={(e) =>
                  update("price", formatPriceRub(e.target.value))
                }
              />
              ...
              <input
                ...
                onChange={(e) =>
                  update("price_usd", formatNumber(e.target.value))
                }
              />
              ...
              <input
                ...
                value={form.usd_rate}
                onChange={(e) =>
                  update("usd_rate", formatNumber(e.target.value))
                }
              />
              ...
              <input
                ...
                onChange={(e) =>
                  update("price_eur", formatNumber(e.target.value))
                }
              />
            ...
            {files.length > 0 && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                {files.map((file, index) => (
                  <div
                    key={`${file.name}-${index}`}
                    className="relative bg-white rounded-xl overflow-hidden h-40"
                  >
                    {index === 0 && (
                    ...
                    <button
                      ...
                      className="absolute top-2 right-2 bg-black/80 text-white rounded-full w-8 h-8"
                    >
                      ×
                    </button>
                    ...
                    <div className="absolute bottom-2 left-2 right-2 flex gap-2">
                      <button
                        ...
                        disabled={index === 0}
                        className="flex-1 bg-black/80 disabled:opacity-30 text-white rounded-lg py-1"
                      >
                        ←
                      </button>
          ...
          <textarea
            className="w-full bg-zinc-900 border border-zinc-700 rounded-xl p-4 min-h-48"
          ...
          <div className="bg-zinc-900 rounded-3xl p-8 border border-zinc-800">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <input
                ...
                value={form.weight}
                onChange={(e) =>
                  update("weight", withUnit(e.target.value, "кг"))
                }
              />
              ...
              <input
                ...
                value={form.length}
                onChange={(e) =>
                  update("length", withUnit(e.target.value, "мм"))
                }
              />
              ...
              <input
                ...
                value={form.height}
                onChange={(e) =>
                  update("height", withUnit(e.target.value, "мм"))
                }
              />
              ...
              <input
                ...
                value={form.width}
                onChange={(e) =>
                  update("width", withUnit(e.target.value, "мм"))
                }
              />

              <input
                className="w-full bg-black border border-zinc-700 rounded-xl p-4 md:col-span-2"
                placeholder="Макс. нагрузка, кг"
                value={form.maxLoad}
                onChange={(e) =>
                  update("maxLoad", withUnit(e.target.value, "кг"))
                }
              />
            </div>
          </div>
